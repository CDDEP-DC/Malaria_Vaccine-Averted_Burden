...
data1.loc[data1['year'] <= 2024, 'inc_byage_min'] = data1['malaria_prev_min'] * data1['1_4prop_est'] / data1['Pop1_4']
...
country_rates = country_rates[['country', 'at_risk', 'coverage','malaria_prev','malaria_prev_min','malaria_prev_max',
                               '1_4est','5_9est','Allages_est','Pop1_4','Pop5_9','inc_byage','inc_byage_min','inc_byage_max', 'trr','pcr','tfr','CFR_malaria']].set_index('country')
...
country_rates = country_rates[['country', 'at_risk', 'coverage','WHOcases','WHOcases_min','WHOcases_max',
                               ...
                               'trr','pcr','tfr','CFR_malaria']].sort_values(by='country')
...
data1 = data1[['country','year','Pop1', 'coverage', 'inc_byage','trr','pcr','pcr_increasing','CFR_malaria','VE0', 'VE1', 'VE2', 'VE3']]
...
for ve in scenarios:
    ...
    malaria['Ires'] = malaria['I'] * malaria['trr'] * malaria['pcr']
    malaria['Ires2'] = malaria['I'] * malaria['trr'] * malaria['pcr_increasing']
